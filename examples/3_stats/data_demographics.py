...
if __name__ == "__main__":
    ...
    mapping_dict = {
        "MCID_classes": {
            "cols_to_keep": ["Neurol_cond", "Lesion_num", "Nb sessions", "Sex", "Age",
                              "BMI", "6MWT_m_pre", "10MWT_pas_pre", "10MWT_sec_pre",
                              "delay_injury", "delay_loko", "functional_level", "speed"],
      
            "cat_cols": ["Sex", "functional_level", "Neurol_cond", "Nb sessions", "Lesion_num"],
            "cont_cols": ["Age", "BMI", "6MWT_m_pre", "10MWT_pas_pre", "10MWT_sec_pre", "delay_injury", "delay_loko", "speed"],
        },
        "Neurol_cond": {
            "cols_to_keep": ["Neurol_cond", "Lesion_num", "Nb sessions", "Sex", "Age",
                              "BMI", "6MWT_m_pre", "10MWT_pas_pre", "10MWT_sec_pre",

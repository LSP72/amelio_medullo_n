...
def save_dict(results_dict, output_path, separated_sessions=True):
    pickle_file_name = output_path + "/loko_results_5_selected_features_after_lasso.pkl"
...
if __name__ == "__main__":
    ...
    # 5 selected features from Lasso
    cols_to_keep_5 = [
        "nb_sessions",
        "BWS_%_MOY",
        "Guidage_%_MOY",
    ...
    main(data_path, cols_to_keep_5, random_state_list, output_path)

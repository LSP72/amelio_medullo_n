...
def main(data_path, cols_to_keep):
    ...
    pickle_file_name = "results/uni_multi_variate/univariate_results_profile_dataset.pkl"
    with open(pickle_file_name, "wb") as file:
        pkl.dump(univariate_df, file)
    univariate_df.to_excel("results/uni_multi_variate/univariate_results_profile_dataset.xlsx")

...
def train_and_test_catboost(X, y, train_index, test_index, rdm_state=42):
...
def main(data_path, cols_to_keep, random_state_list, output_path, num=True):
    ...
    for i, (train_index, test_index) in enumerate(loo.split(X)):
        ...
        results_dict[i] = train_and_test_catboost(X, y, train_index, test_index, rdm_state=42)
        results_dict[i]["list_of_features"] = cols_to_keep

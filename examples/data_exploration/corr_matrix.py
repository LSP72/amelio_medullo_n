...
def plot_and_save_corr_matrix(data, output_name, output_file_path):
    ...
    sns.heatmap(correlation_matrix, annot=True, fmt=".2f", cmap="coolwarm", center=0, annot_kws={"size": 10}, square=True)
...
if __name__ == '__main__':
    ...
    cols_to_keep_profile_1 = [ "Sex",	"Age",	"Height",	"Weight",	"6MWT_m_pre",	"10MWT_pas_pre",	"10MWT_sec_pre",	"6MWT_m_post",	"delay_injury",	"delay_loko",
    ...
    "Knee_ext",	"Ank_flex_90",	"Ank_flex_180",	"Ank_ext",	"H_Flex_ass",	"H_Ext_PP",	"H_abd",	"H_add",	"H_rot_int",	"K_Flex",	"K_Ext",	"A_Dorsiflex_GT",	"A_Plantarflex"]
        # + Lesion & Neurol_cond
    cols_to_keep_profile_2 =   ['Sex', 'Age', 'Height', 'Weight', '6MWT_m_pre', '10MWT_pas_pre', '10MWT_sec_pre', '6MWT_m_post', 'delay_injury', 'delay_loko', 'functional_level']
    cols_to_keep_loko_1 = ["nb_sessions",	"duration",	"Distance_m",	"Distance_pas",	"Durée_min",	"Vitesse_kmh_MIN",	"Vitesse_kmh_MAX",	"Vitesse_kmh_MOY",	"BWS_%_MIN",	"BWS_%_MAX",
    ...
    cols_to_keep_loko_2 = ["nb_sessions",	"duration",	"Distance_m",	"Distance_pas",	"Durée_min",	"Vitesse_kmh_MOY",
                         "BWS_%_MOY", "Guidage_G_%_MOY", "Guidage_D_%_MOY",	"sessions_per_week",	"6MWT_m_pre",	"6MWT_m_post",
                         "MCID_classes",	"functional_level"]
    cols_to_keep_loko_3 = ["nb_sessions",	"duration",	"Durée_min", "Vitesse_kmh_MOY", "BWS_%_MOY", "step_length",

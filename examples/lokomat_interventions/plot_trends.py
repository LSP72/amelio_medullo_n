...
features = ["Distance_m", "Durée_min", "Vitesse_kmh_MOY", "BWS_%_MOY", "Guidage_G_%_MOY", "Guidage_D_%_MOY"]   # replace with your actual column names
...
for i, feature in enumerate(features):
    ...
    for patient_id, group in df.groupby(id_col):
        ...
        ax.plot(
            group_sorted[session_col],
            group_sorted[feature],
            marker='o',
            alpha=0.5,

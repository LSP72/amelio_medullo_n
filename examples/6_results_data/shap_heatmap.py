...
def _normalise_shap(sv, X_test, model, cat_features):
    ...
    if sv.shape[1] == n_features + 1:  # bias column tacked on the end
        ...
        raise ValueError(f"shap array has {sv.shape[1]} columns but X has {n_features} features")
...
if __name__ == "__main__":
    ...
    plot_heatmap(expl_pooled, title="SHAP heatmap — mean over out-of-fold test appearances")
